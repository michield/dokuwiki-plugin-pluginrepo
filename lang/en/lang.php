...
$lang['security_requirespatch']   = 'The plugin requires patching the core. Manual patches may break compatibility with other plugins and make it harder to secure your installation by upgrading to latest version.';
...
$lang['t_typesyntax']        = '%s plugins extend the basic syntax.';
...
$lang['t_typetemplate']      = '%s changes the look and feel';
